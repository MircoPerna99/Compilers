...
%type <integer> INT
%type <str> STRING_VALUE FISCAL_CODE DATE_VALUE DEGREE_COURSE ACADEMIC_YEAR
...
%token CANDIDATE_HIGH_SCHOOL_VOTE_PROPERTY CANDIDATE_TEST_VOTE_PROPERTY CANDIDATE_COURSE_PROPERTY
...
High_School_Vote : CANDIDATE_HIGH_SCHOOL_VOTE_PROPERTY EQUAL_TO INT DIVEDER {insert_candidate_high_school_vote($3);} 
